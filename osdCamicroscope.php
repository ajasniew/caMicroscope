...
.modal a.close-modal{
  ...
  right: 0;
    ...
    <body>
	    ...
	    <div id="weightpanel"><div id="bar1" class="bar" align="right"><div id="slide1" class="slide"></div></div><label class="lb_heatmap"><input type="checkbox" id="cb1" checked>  Lymphocyte Sensitivity</label><div id="bar2" class="bar"><div id="slide2" class="slide"></div></div><label class="lb_heatmap"><input type="checkbox" id="cb2" checked> Necrosis Specificity</label><br><button type="button" class="btn_heatmap" id="btn_saveHeatmapWeight">Save</button></div>

	    <div id="markuppanel"><input type="radio" name="marktype" value="LymPos" checked="checked" id="LymPos" class="radio_markup"> <label class = radio_markup>LymPos</label><br><input type="radio" name="marktype" value="LymNeg" id="LymNeg" class="radio_markup"> <label class = radio_markup>LymNeg</label><br><input type="radio" name="marktype" value="TumorPos" id="TumorPos" class="radio_markup"> <label class = radio_markup>TumorPos</label><br><input type="radio" name="marktype" value="TumorNeg" id="TumorNeg" class="radio_markup"> <label class = radio_markup>TumorNeg</label><br> <input type="radio" name="marktype" value="Moving" id="rb_Moving" class="radio_markup"> <label class = radio_markup>Moving</label><br>  <button type="button" class="btn_mark" id="btn_savemark">Save</button>  <button type="button" class="btn_mark" id="btn_undomark" >Undo</button> </div>
